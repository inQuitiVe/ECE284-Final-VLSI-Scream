#!/usr/bin/env python3
"""
Transpose weight files from golden/os4bit/ref/ to golden/os4bit/
Converts col-row format to row-col format (transpose)
"""
...
def transpose_weight_file(input_file, output_file):
    ...
    Output format: Each line represents a row with 8 columns
                   ...
                   Each line: 32 bits = 8 x 4-bit values (col0 to col7)
    """
