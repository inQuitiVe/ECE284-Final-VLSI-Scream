...
input_path = os.path.join(script_dir, "output.txt")  # ws2bit uses output.txt as input
...
# ws2bit has 16 channels per line (256 bits), ws4bit has 8 channels (128 bits)
num_channels = 16
bits_per_line = num_channels * 16  # 256 bits
...
for line in lines:
    ...
    # Format viz line: 16 values with spacing (format: "     12      17      30       0       0      21       0      17      57       0       0      15       0      45       0       0")
...
output_elu_path = os.path.join(script_dir, "output_elu.txt")
output_leaky_path = os.path.join(script_dir, "output_leaky.txt")
output_gelu_path = os.path.join(script_dir, "output_gelu.txt")
...
viz_elu_path = os.path.join(script_dir, viz_dir, "viz_output_elu.txt")
viz_leaky_path = os.path.join(script_dir, viz_dir, "viz_output_leaky.txt")
viz_gelu_path = os.path.join(script_dir, viz_dir, "viz_output_gelu.txt")
